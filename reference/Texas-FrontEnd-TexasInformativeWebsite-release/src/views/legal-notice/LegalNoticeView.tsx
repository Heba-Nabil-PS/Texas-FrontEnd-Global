...
interface LegalNoticeViewProps {
  headerLegal: AdvancedContentCategoryProps | undefined;
}

const LegalNoticeView = ({ headerLegal }: LegalNoticeViewProps) => {
  return (
    <main className="container mx-auto min-h-screen bg-white px-4 py-20 text-black sm:px-6 md:py-28 lg:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        {headerLegal?.DescriptionLong?.trim() && (
          <div
            dangerouslySetInnerHTML={{
              __html: domSanitize(headerLegal.DescriptionLong?.trim()),
            }}
...
export const serverClasses =
  "font-black w-full overflow-x-auto prose prose-lg mb-12 max-w-none mb-4 mt-10 text-2xl font-semibold mb-3 text-gray-700 mb-3 mt-6 text-xl font-semibold mb-1";
